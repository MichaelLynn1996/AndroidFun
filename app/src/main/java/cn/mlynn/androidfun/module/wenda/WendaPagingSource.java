 ...
 * @ClassName: WendaPagingSource
 * @Description: //TODO
 * @Author: Michael Lynn
 * @CreateDate: 2020/7/11 15:02
 */
...
public class WendaPagingSource extends ListenableFuturePagingSource<Integer, Article> {
    ...
    public WendaPagingSource(RequestApi requestApi) {
    ...
    public ListenableFuture<LoadResult<Integer, Article>> loadFuture(@NotNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Article>> pageFuture = Futures
                .transform(requestApi.getWenda(nextPageNumber)
                        , this::toLoadResult
                        , mBgExecutor);
