 ...
 * @ClassName: SquareDataSource
 * @Description: //TODO
 * @Author: Michael Lynn
 * @CreateDate: 2020/7/11 10:51
 */
...
public class SquarePagingSource extends ListenableFuturePagingSource<Integer, Article> {
    ...
    public SquarePagingSource(RequestApi requestApi) {
    ...
    public ListenableFuture<LoadResult<Integer, Article>> loadFuture(@NotNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Article>> pageFuture = Futures
                        .transform(requestApi.getSquare(nextPageNumber)
                                , this::toLoadResult
                                , mBgExecutor);
