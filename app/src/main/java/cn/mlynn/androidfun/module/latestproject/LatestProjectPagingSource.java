 ...
 * @ClassName: LatestProjectPagingSource
 * @Description: //TODO
 * @Author: Michael Lynn
 * @CreateDate: 2020/7/11 15:29
 */
...
public class LatestProjectPagingSource extends ListenableFuturePagingSource<Integer, Article> {
    ...
    public LatestProjectPagingSource(RequestApi requestApi) {
    ...
    public ListenableFuture<LoadResult<Integer, Article>> loadFuture(@NotNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Article>> pageFuture = Futures
                .transform(requestApi.getLatestProject(nextPageNumber)
                        , this::toLoadResult
                        , mBgExecutor);
